  ...
  const sampleSignals = [
    {
      ...
      sources: JSON.stringify([{ publisher: "trade press", url: "https://www.packaginglaw.com/eu-green-claims" }]),
      dedupHash: "hash-001",
      isIllustrative: true,
    },
    {
      ...
      sources: JSON.stringify([{ publisher: "company comms", url: "https://www.unilever.com/news/press-releases/scaling-ai" }]),
      dedupHash: "hash-002",
      isIllustrative: true,
    },
    {
      ...
      sources: JSON.stringify([
        { publisher: "Reuters", url: "https://www.reuters.com/business/unilever-mccormick-foods-deal" },
        { publisher: "SEC (Form 425)", url: "https://www.sec.gov/Archives/edgar/data/31529/unilever-mccormick" }
      ]),
      dedupHash: "hash-009",
      isIllustrative: true,
    },
    {
      ...
      sources: JSON.stringify([{ publisher: "Unilever FY2025 results", url: "https://www.unilever.com/investor-relations/results" }]),
      dedupHash: "hash-010",
      isIllustrative: true,
    },
    {
      ...
      sources: JSON.stringify([{ publisher: "company RNS", url: "https://www.londonstockexchange.com/rns/unilever-ice-cream" }]),
      dedupHash: "hash-011",
      isIllustrative: true,
    },
    {
      ...
      sources: JSON.stringify([{ publisher: "financial press", url: "https://www.ft.com/content/nestle-leadership" }]),
      dedupHash: "hash-006",
      isIllustrative: true,
    }
  ];
